...
reqtrace call post_indexes_item_dev_query --body '{"query":"vector search"}'
...
To give an agent the tools, register the MCP server. In an MCP-aware editor the bundled
